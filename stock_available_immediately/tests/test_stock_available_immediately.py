...
the variations in stock, both on product and template"""
        ...
        # fill the move line
        move_line = stockMoveInA.move_line_ids[0]
        self.assertEqual(move_line.product_qty, 2.0)
        ...
        move_line = stockMoveInB.move_line_ids[0]
        self.assertEqual(move_line.product_qty, 3.0)
        self.assertEqual(move_line.qty_done, 0.0)
